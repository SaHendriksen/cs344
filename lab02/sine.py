...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        total_initial_val = total_initial + p.value(initial)
        ...
        total_hill_val = total_hill + p.value(hill_solution)
       ...
       # print(aneal_end - anneal)
        ...
        total_anneal_val = total_anneal + p.value(annealing_solution)

        print("\n")

    print("Total initial value is: " + str(total_initial))
    print("Total hill value is: " + str(total_hill))
    print("Total anneal value is: " + str(total_anneal))
    print("\n")

    print("Average initial value is: " + str(total_initial / 10))
    print("Average hill value is: " + str(total_hill / 10))
    print("Average anneal value is: " + str(total_anneal / 10))